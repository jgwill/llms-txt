...
Full payload shapes live in `@miadi/a2a-contracts` (`https://miadi.jgwill.com/packages/a2a-contracts/src/interfaces.ts`).
...
- `https://miadi.jgwill.com/rispecs/a2a/06-hawk-inspired-next-gen.spec.md` — v2 direction-setting spec
...
- HAWK paper: `https://miadi.jgwill.com/foundations/sources/HAWK/2507.04067v1.pdf` (Cheng et al. 2025)
