...
## 🧠 AI Interaction Principles {#ai-interaction-principles}
...
## 🤖 AI Interaction Guidelines {#interaction-guidelines}
...
## 💡 Computational Creativity Guidance {#creativity-guidance}

### Philosophical Interaction Principles {#philosophical-principles}
- **Every Command is a Creative Act**: CLI interactions are not just functional—they are generative
...
## 🤝 Intellectual Property and Sharing {#ip-and-sharing}
...
## 🖥️ CLI Command Ecosystem {#cli-command-ecosystem}
...
### 🖋️ Storytelling-Specific Pipeline Templates {#storytelling-templates}
...
#### Langfuse Comments Tools (3) ✨ NEW in v0.1.9
