# Counter-Article Template: Type 2 - Critical Review / Systematic Critique
...
- You need to expose specific assumptions embedded in a source
- Source has significant influence and its paradigm spreads through citation
- Readers need education on why paradigm difference is consequential
- You're building toward a methodological schism or epistemic injustice argument

---

## Structure

### 1. Map Their Paradigm
**Length**: 2-3 paragraphs

**Questions to Answer**:
- What ontological assumptions does this source make? (What do they consider real?)
- What epistemological assumptions? (How do they claim to produce knowledge?)
- What axiological assumptions? (What values guide their work?)
- What methodological assumptions? (What process do they use?)
...
**Questions to Answer**:
- Where specifically does this framework contradict relational principles?
- What gets erased? (spirituality? more-than-human agency? collective intelligence?)
- How does this violate reciprocity, consent, accountability?
- What would need to be different for this work to be relationally accountable?

**Relational Principles to Check Against**:
- Reciprocity: Does knowledge flow both ways?
- Consent: Do all actors (human + more-than-human) participate?
- Accountability: Who is the researcher accountable to?
- Transformation: Does research change the researcher?
- More-than-human agency: Are non-human actors recognized?
...
**Questions to Answer**:
- How does this framework reinforce Western problem-solving orientation?
- Is this bias intentional or structural? (Usually structural—author likely unaware)
- Who benefits from this bias? What institutions reward it?
...
### 4. Demonstrate Alternative
**Length**: 2-3 paragraphs

**Questions to Answer**:
- What would this research look like from relational/ceremonial paradigm?
- What methods would you use instead?
- What would you measure? What would count as evidence?
- What outcomes would be different?
...
### 5. Implication: What Gets Lost
**Length**: 1-2 paragraphs

**Questions to Answer**:
- What understanding is lost by accepting this framework?
- What communities are harmed by this paradigm's influence?
- What future research directions are blocked?
- What would change if your critique were taken seriously?
...
- **Reverse Engineering**: What paradigm assumptions built this source?
- **Intent**: What outcomes does this source want? (vs. what it produces)
- **Specifications**: What would this work need to change to be relationally accountable?
- **Exportation**: How does this critique help others navigate similar sources?
...
### Avoid
- "This author is wrong" (dismissive, not analytical)
- "This framework is bad" (evaluative without analysis)
- "They don't understand" (personal criticism)
- "This is colonial" (without specific mechanism)

### Use
- "This framework, operating from [assumption], produces..."
- "The paradigm erases [specific element] by..."
- "From relational ontology, this becomes visible..."
- "The structural bias, not personal failure, produces..."

---

## Checklist Before Finalizing

- [ ] All four Wilson pillars mapped for source
- [ ] Violation located at specific paradigm level (not surface)
- [ ] Bias identified as structural (not personal failure)
- [ ] Relational alternative demonstrated (not just criticized)
- [ ] Implication shows consequential harm (not abstract disagreement)
- [ ] Language maintains relational tone (critiques framework, not person)
- [ ] Pollution detection checklist referenced
- [ ] Wilson's four pillars contrast complete
- [ ] RISE framework integrated
