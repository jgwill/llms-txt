...
- **RelationalNodeRetriever** — surfaces nodes constrained by direction, ceremony context, or OCAP flags
- **NarrativeBeatPlanner** — uses Structural Tension Charts and Narrative Beats to generate next steps in research or ceremony
...
- **File creation** is a relational act — every new artifact enters a kinship network
- **Refactoring** is relational change — positions shift within the kin map
- **Commits** carry narrative meaning — not just what changed, but what it means relationally
- **Reviews** use MMOT — truth as a verb, turning discrepancies into learning
...
See: [Creative Orientation](creative-orientation.md) · [Structural Tension](structural-tension.md) · [Delayed Resolution](../llms-delayed-resolution-principle.md)

---

## Relationship to Relational Science

[Relational Science](relational-science.md) provides the epistemological ground — **how knowledge works relationally**.
...
- [Medicine Wheel Research](medicine-wheel-research.md) — [llms-inquiry-medicine-wheel](../llms-inquiry-medicine-wheel-abundance-intelligence-research--d971fc13-64ee-41ab-8fcd-bb5900197ab8.md)
- [Indigenous Research Paradigm](indigenous-research-paradigm.md) — [llms-inquiry-6406eb37](../llms-inquiry-6406eb37-69b1-471d-9cac-07ae69449c35.md)
- [Kinship Hub System](kinship-hub.md) — [llms-kinship-hub-system-full.md](../llms-kinship-hub-system-full.md)
- [KINSHIP.md](../KINSHIP.md) — this repo's relational charter
